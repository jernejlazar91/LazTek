    ...
    <main className="laztek-page">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 pt-14 sm:px-6 lg:px-8 lg:pb-24 lg:pt-20">
        <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          ...
          <div className="rounded-[2rem] border border-cyan-300/18 bg-gradient-to-br from-cyan-400/14 via-sky-500/10 to-blue-600/10 p-6 shadow-[0_20px_80px_rgba(0,0,0,0.25)]">

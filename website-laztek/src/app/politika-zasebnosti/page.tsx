...
import {Breadcrumbs} from '@/components/engineering/DesignSystem'
  ...
  return (
    <>
      ...
      <main id="vsebina" tabIndex={-1} className="lt-theme">
        <div className="lt-container lt-privacy">
          ...
          <section className="mx-auto max-w-5xl px-6 pb-24 pt-24 sm:px-8 lg:px-10">
            <div className="max-w-3xl">
              ...
              <p className="mt-6 text-base leading-8 text-white/60">
                ...
                preko spletne strani LazTek Engineering, zakaj jih obdelujemo,
                kako dolgo jih hranimo ter kakšne pravice imate v zvezi s
                svojimi osebnimi podatki.
              </p>
            ...
            <nav
              className="lt-legal-nav"
              aria-label="Vsebina politike zasebnosti"
            >
              <a href="#zasebnost-1">Upravljavec</a>
              <a href="#zasebnost-2">Podatki</a>
              <a href="#zasebnost-3">Namen obdelave</a>
              <a href="#zasebnost-4">Pravna podlaga</a>
            </nav>
            <div className="mt-14 space-y-10">
              <Section title="1. Upravljavec osebnih podatkov">
                ...
                <div className="mt-4 rounded-2xl border border-cyan-200/15 bg-[#071b2d]/65 shadow-[0_18px_58px_rgba(0,15,27,0.20)] backdrop-blur-xl p-5">
                  ...
                  <p className="mt-1 text-white/60">LazTek Engineering</p>
              ...
              <Section title="3. Namen obdelave podatkov">
                <p>Osebne podatke obdelujemo predvsem za:</p>

                <ul className="mt-4 list-disc space-y-2 pl-6">
                  <li>obravnavo vašega povpraševanja,</li>
                  <li>pripravo ponudbe oziroma odgovora na vaše vprašanje,</li>
                  <li>komunikacijo glede projekta, storitve ali naročila,</li>
                  <li>pregled tehničnih in CAD datotek, ki jih posredujete,</li>
                  <li>
              ...
              <Section title="4. Pravna podlaga">
                ...
                <p className="mt-4">
                  Določene tehnične podatke lahko obdelujemo tudi zaradi našega
                  zakonitega interesa za zagotavljanje varnega in zanesljivega
                  delovanja spletne strani ter preprečevanje zlorab.
                </p>
              </Section>
              ...
              <Section title="5. Posredovanje podatkov zunanjim ponudnikom">
                <p>
                  ...
                  ponudnike storitev. Podatki se jim posredujejo samo v obsegu,
                  ki je potreben za izvedbo posamezne storitve.
                </p>
              ...
              <Section title="6. Cloudflare Turnstile">
                <p>
                  Na kontaktnem obrazcu uporabljamo Cloudflare Turnstile. Njegov
                  namen je preveriti, ali zahtevo pošilja dejanski uporabnik in
                  ne avtomatiziran sistem.
                </p>

                <p className="mt-4">
                  Turnstile lahko pri tem obdeluje določene tehnične podatke o
                  napravi, povezavi in obisku, ki so potrebni za izvedbo
              ...
              <Section title="7. Priložene CAD in tehnične datoteke">
                <p>
                  Če kontaktni obrazec uporabljate za pošiljanje datotek, se te
                  shranijo v zasebno mapo, namenjeno obravnavi posameznega
                  povpraševanja.
                </p>
              ...
              <Section title="8. Čas hrambe">
                <p>
                  ...
                  potrebno za obravnavo povpraševanja, pripravo ponudbe, izvedbo
                  dogovorjene storitve ter morebitne zakonske obveznosti.
                </p>

                <p className="mt-4">
                  Če do poslovnega sodelovanja ne pride, lahko podatke po
                  preteku razumnega obdobja izbrišemo, razen kadar obstaja druga
                  zakonita podlaga za njihovo nadaljnjo hrambo.
                </p>
              </Section>
              ...
              <Section title="9. Vaše pravice">
                ...
                <ul className="mt-4 list-disc space-y-2 pl-6">
                  ...
                  <li>
                    prenos podatkov, kadar so za to izpolnjeni zakonski pogoji.
                  </li>
                </ul>
                ...
                <p className="mt-4">
                  Pravico imate tudi vložiti pritožbo pri pristojnem nadzornem
                  organu za varstvo osebnih podatkov.
                </p>
              </Section>
              ...
              <Section title="10. Varnost podatkov">
                <p>
                  ...
                  nepooblaščenim dostopom, izgubo, zlorabo ali spreminjanjem.
                </p>

                <p className="mt-4">
                  Nalaganje CAD datotek je dodatno zaščiteno z varnostnim
                  preverjanjem in časovno omejenimi avtorizacijskimi dovoljenji.
                </p>
              </Section>

              <Section title="11. Piškotki">
                <p>
                  Spletna stran lahko uporablja tehnično nujne podatke oziroma
                  tehnologije, potrebne za pravilno in varno delovanje.
                </p>

                <p className="mt-4">
                  Če bodo v prihodnosti dodane analitične, marketinške ali druge
                  neobvezne tehnologije, bo politika zasebnosti po potrebi
                  ustrezno dopolnjena.
                </p>
              </Section>
              ...
              <Section title="12. Spremembe politike zasebnosti">
                <p>
                  ...
                  sprememb spletne strani, uporabljenih storitev ali zakonskih
                  zahtev.
                </p>

                <p className="mt-4">
                  Na tej strani bo vedno objavljena trenutno veljavna različica.
                </p>
              </Section>
...
function Section({
  ...
  return (
    <section
      id={`zasebnost-${title.split('.')[0]}`}
      className="rounded-[2rem] border border-cyan-200/12 bg-[#071b2d]/58 backdrop-blur-xl p-6 sm:p-8"
    >
...
function Service({name, description}: {name: string; description: string}) {
  return (

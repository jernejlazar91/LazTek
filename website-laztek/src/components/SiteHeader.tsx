  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
      ...
      >
        ...
        <g fill="none" stroke="url(#gridStroke)" strokeWidth="1.1" opacity=".78">
        ...
        <g fill="none" stroke="url(#gridStroke)" strokeWidth="1.1" opacity=".92">
        ...
        <g filter="url(#softGlow)">
          <path d="M0 155H255" stroke="url(#activeEdge)" strokeWidth="1.4" opacity=".4" />
          <path d="M1510 155H1800" stroke="url(#activeEdge)" strokeWidth="1.4" opacity=".42" />
    ...
    <>
      ...
      <span
        ...
        className={[
          ...
          strong ? 'opacity-95' : active ? 'opacity-82' : 'opacity-22 group-hover:opacity-70',
        ].join(' ')}
      />
      <span
        aria-hidden="true"
        className={[
          ...
          strong ? 'opacity-80' : active ? 'opacity-60' : 'opacity-10 group-hover:opacity-48',
        ].join(' ')}
      />
      ...
      <span
        ...
        className={[
          ...
          strong ? 'opacity-90' : active ? 'opacity-76' : 'opacity-15 group-hover:opacity-62',
        ].join(' ')}
      />
      <span
        aria-hidden="true"
...
export default function SiteHeader({
  ...
  const homeHref = basePath ? '/#domov' : '#domov'
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-cyan-300/[0.10] shadow-[0_18px_54px_rgba(0,7,14,.34)] backdrop-blur-xl">
      <HeaderBackdrop />

      {/* ultra-compact contact / engineering strip */}
      <div className="relative z-20 border-b border-white/[0.055] bg-black/[0.12]">
        ...
        <div className="mx-auto grid min-h-[128px] max-w-[1880px] grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-[10px] px-7 min-[1750px]:gap-[16px] min-[1750px]:px-9">
          ...
          <nav className="flex min-w-0 items-center justify-center gap-[5px] min-[1750px]:gap-[7px]">
            ...
            >
              ...
              <span className="relative z-10 flex items-center gap-2">
                <Home className="h-[14px] w-[14px] min-[1750px]:h-[15px] min-[1750px]:w-[15px] text-cyan-200/90" strokeWidth={2.2} />
                Domov
              </span>
            </Link>
            ...
            >
              ...
              <span className="relative z-10 flex items-center gap-2">
                <Building2 className="h-[14px] w-[14px] min-[1750px]:h-[15px] min-[1750px]:w-[15px] text-cyan-100/74" strokeWidth={2.1} />
                O podjetju
              </span>
            </Link>
            ...
            >
              <button
                ...
                className={navButtonClass(isActive('/storitve') || servicesOpen)}
                style={{clipPath: HEX}}
              ...
              >
                ...
                <span className="relative z-10 flex items-center gap-2">
                  <Wrench className="h-[14px] w-[14px] min-[1750px]:h-[15px] min-[1750px]:w-[15px] text-cyan-100/76" strokeWidth={2.1} />
                  Storitve
                  <ChevronDown
                    className={`h-[13px] w-[13px] transition-transform duration-200 ${
                      servicesOpen ? 'rotate-180 text-cyan-200' : 'text-white/56'
                    }`}
                  />
                </span>
              </button>
            ...
            >
              ...
              <span className="relative z-10 flex items-center gap-2">
                <Box className="h-[14px] w-[14px] min-[1750px]:h-[15px] min-[1750px]:w-[15px] text-cyan-100/74" strokeWidth={2.1} />
                LINEX HT v1
              </span>
            </Link>
            ...
            >
              ...
              <span className="relative z-10 flex items-center gap-2">
                <Layers3 className="h-[14px] w-[14px] min-[1750px]:h-[15px] min-[1750px]:w-[15px] text-cyan-100/74" strokeWidth={2.1} />
                Materiali
              </span>
            </Link>
            ...
            >
              ...
              <span className="relative z-10 flex items-center gap-2">
                <Folder className="h-[14px] w-[14px] min-[1750px]:h-[15px] min-[1750px]:w-[15px] text-cyan-100/74" strokeWidth={2.1} />
                Projekti
              </span>
            </Link>
            ...
            >
              ...
              <span className="relative z-10 flex items-center gap-2">
                <ImageIcon className="h-[14px] w-[14px] min-[1750px]:h-[15px] min-[1750px]:w-[15px] text-cyan-100/74" strokeWidth={2.1} />
                Galerija
              </span>
            </Link>
            ...
            >
              ...
              <span className="relative z-10 flex items-center gap-2">
                <FileText className="h-[14px] w-[14px] min-[1750px]:h-[15px] min-[1750px]:w-[15px] text-cyan-100/74" strokeWidth={2.1} />
                Blog
              </span>
            </Link>
          </nav>
          ...
          >
            ...
            <span className="relative z-10 flex items-center gap-2.5 [text-shadow:0_0_14px_rgba(255,255,255,.10)]">
              <Send className="h-[17px] w-[17px] text-cyan-50" strokeWidth={2.2} />
      ...
      */}
        ...
        <div className="mx-auto max-w-[1500px] px-6 lg:px-8">
          ...
          <nav className="flex items-center justify-center gap-[7px] pb-[16px]">
            ...
            >
              <HexFrame active={pathname === '/'} />
              <span className="relative z-10 flex items-center gap-2">
                <Home className="h-[14px] w-[14px] text-cyan-200/90" strokeWidth={2.2} />
                Domov
              </span>
            </Link>
            ...
            >
              <HexFrame active={isActive('/o-podjetju')} />
              <span className="relative z-10 flex items-center gap-2">
                <Building2 className="h-[14px] w-[14px] text-cyan-100/74" strokeWidth={2.1} />
                O podjetju
              </span>
            </Link>
            ...
            >
              ...
              >
                <HexFrame active={isActive('/storitve') || servicesOpen} />
                <span className="relative z-10 flex items-center gap-2">
                  <Wrench className="h-[14px] w-[14px] text-cyan-100/76" strokeWidth={2.1} />
                  Storitve
                  <ChevronDown
                    className={`h-[13px] w-[13px] transition-transform duration-200 ${
                      servicesOpen ? 'rotate-180 text-cyan-200' : 'text-white/56'
            ...
            >
              <HexFrame active={isActive('/linex')} />
              <span className="relative z-10 flex items-center gap-2">
                <Box className="h-[14px] w-[14px] text-cyan-100/74" strokeWidth={2.1} />
                LINEX HT v1
              </span>
            </Link>
            ...
            >
              <HexFrame active={isActive('/materiali')} />
              <span className="relative z-10 flex items-center gap-2">
                <Layers3 className="h-[14px] w-[14px] text-cyan-100/74" strokeWidth={2.1} />
                Materiali
              </span>
            </Link>
            ...
            >
              <HexFrame active={isActive('/projekti')} />
              <span className="relative z-10 flex items-center gap-2">
                <Folder className="h-[14px] w-[14px] text-cyan-100/74" strokeWidth={2.1} />
                Projekti
              </span>
            </Link>
            ...
            >
              <HexFrame active={isActive('/galerija')} />
              <span className="relative z-10 flex items-center gap-2">
                <ImageIcon className="h-[14px] w-[14px] text-cyan-100/74" strokeWidth={2.1} />
                Galerija
              </span>
            </Link>
            ...
            >
              <HexFrame active={isActive('/blog')} />
              <span className="relative z-10 flex items-center gap-2">
                <FileText className="h-[14px] w-[14px] text-cyan-100/74" strokeWidth={2.1} />
                Blog
              </span>
            </Link>
          </nav>
      ...
      <div className="relative z-20 min-[1100px]:hidden">
        ...
        {mobileOpen ? (
          <div className="border-t border-cyan-200/[0.08] bg-[#03111d]/[0.985] px-4 pb-5 pt-3 shadow-[0_28px_70px_rgba(0,4,10,.6)] backdrop-blur-2xl sm:px-6 lg:px-8">
